...
| `brief.*`                                                         | квиз: пять шагов, варианты ответов, согласие на обработку данных, ошибка отправки                             |
| `brief.budgets.*`                                                 | вилки бюджета в EN даны в долларах по курсу тарифов, а не переведены из рублей                                |
| `briefThanks.*`                                                   | страница «спасибо» после отправки заявки                                                                      |
